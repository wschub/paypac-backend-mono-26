...
-- CreateIndex
CREATE INDEX "EventView_event_id_createdAt_idx" ON "EventView"("event_id", "createdAt");
CREATE INDEX "EventView_event_id_session_conversion_idx" ON "EventView"("event_id", "session_conversion");
CREATE INDEX "EventView_user_id_idx" ON "EventView"("user_id");
CREATE INDEX "EventView_session_token_idx" ON "EventView"("session_token");
CREATE UNIQUE INDEX "EventView_event_id_session_token_key" ON "EventView"("event_id", "session_token");
