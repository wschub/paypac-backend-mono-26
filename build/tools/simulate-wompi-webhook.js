...
const method = arg('method', 'CARD').toUpperCase();
const status = arg('status', 'APPROVED').toUpperCase();
const amount = parseInt(arg('amount', '30000000'), 10);
const url = arg('url', 'https://paypac-backend-mono-26-production.up.railway.app/api/webhooks/wompi');
const environment = arg('env', 'test');
const email = arg('email', 'david.wschu@gmail.com');
