...
exports.EventStaffAssignmentService = void 0;
...
class EventStaffAssignmentService {
    /**
     * Asignar un STAFF a un evento
     * Solo ORGANIZER (dueño del evento) o PAYPAC pueden asignar
     */
    assignStaffToEvent(eventId, staffUserId, roleType, assignedByUserId, assignedByUserRole) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const staffUser = yield userRepo.findById(staffUserId);
            if (!staffUser) {
            ...
            const alreadyAssigned = yield staffAssignmentRepo.isStaffAssignedToEvent(staffUserId, eventId);
            if (alreadyAssigned) {
                throw new Error('Este usuario ya está asignado a este evento');
            }
            // Crear la asignación
            const assignment = yield staffAssignmentRepo.create({
                event_id: eventId,
                user_id: staffUserId,
                role_type: roleType,
            ...
            try {
                const assignedByUser = yield userRepo.findByIdWithCompany(assignedByUserId);
                const companyName = (_b = (_a = assignedByUser === null || assignedByUser === void 0 ? void 0 : assignedByUser.company) === null || _a === void 0 ? void 0 : _a.company_name) !== null && _b !== void 0 ? _b : 'El organizador';
     ...
     */
    getEventStaff(eventId, userId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            const event = yield eventRepo.findById(eventId);
            if (!event) {
                throw new Error('Evento no encontrado');
            ...
            const isStaff = yield staffAssignmentRepo.isStaffAssignedToEvent(userId, eventId);
     ...
     */
    getMyAssignedEvents(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return staffAssignmentRepo.findByUser(userId);
        });
    }
    getMyNextEvent(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const assignment = yield staffAssignmentRepo.findNextEvent(userId);
            if (!assignment) {
                return { total: 0 };
            }
            return {
     ...
     */
    removeStaffFromEvent(eventId, staffUserId, removedByUserId, removedByUserRole) {
        return __awaiter(this, void 0, void 0, function* () {
            const event = yield eventRepo.findById(eventId);
            if (!event) {
                throw new Error('Evento no encontrado');
            ...
            yield staffAssignmentRepo.deleteByUserAndEvent(staffUserId, eventId);
            return {
     ...
     */
    checkInStaff(userId, eventId, latitude, longitude) {
        return __awaiter(this, void 0, void 0, function* () {
            // Verificar que el STAFF está asignado al evento
            const assignment = yield staffAssignmentRepo.findByUserAndEvent(userId, eventId);
            if (!assignment) {
            ...
            //   }
            // }
            const checkedIn = yield staffAssignmentRepo.checkIn(userId, eventId, latitude, longitude);
            return {
    ...
    checkOutStaff(userId, eventId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const checkedOut = yield staffAssignmentRepo.checkOut(userId, eventId);
            return {
     ...
     */
    canStaffValidateTickets(userId, eventId) {
        return __awaiter(this, void 0, void 0, function* () {
            const assignment = yield staffAssignmentRepo.findByUserAndEvent(userId, eventId);
     ...
     */
    getEventStaffStats(eventId, userId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            const event = yield eventRepo.findById(eventId);
            if (!event) {
                throw new Error('Evento no encontrado');
            ...
            const allStaff = yield staffAssignmentRepo.findByEvent(eventId);
            const checkedIn = yield staffAssignmentRepo.findCheckedInByEvent(eventId);
            return {
    ...
    inviteStaffToEvent(eventId, roleType, doorIdentifier, emailOrPhone, assignedByUserId, assignedByUserRole) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingByEmail = yield userRepo.findByEmail(emailOrPhone);
            const existingByPhone = yield userRepo.search(emailOrPhone);
            if (existingByEmail || existingByPhone.length > 0)
                throw new Error('El usuario ya existe en el sistema. Usa el flujo normal de asignación sin invite=true');
    ...
    //app 
    getEventCheckinStats(eventId, staffUserId) {
        return __awaiter(this, void 0, void 0, function* () {
            const { prisma } = yield Promise.resolve().then(() => __importStar(require('../config/db')));
            const [totalTickets, usedTickets] = yield Promise.all([
...
exports.EventStaffAssignmentService = EventStaffAssignmentService;
