...
exports.getPublicSubgenres = void 0;
const subgenre_service_1 = require("../../services/subgenre.service");
const subgenreService = new subgenre_service_1.SubgenreService();
const getPublicSubgenres = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filters = req.query;
        const result = yield subgenreService.getPublicSubgenres(filters);
...
exports.getPublicSubgenres = getPublicSubgenres;
