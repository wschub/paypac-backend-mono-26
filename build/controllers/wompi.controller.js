...
const wompiWebhook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (event === 'transaction.updated') {
            yield handleTransactionUpdated(data.transaction);
        }
        else {
...
function handleTransactionUpdated(transaction) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (transactionRecord) {
            ...
            transactionRecord = yield transactionRepo.update(transactionRecord.id, {
                status: status,
        ...
        if (status === 'APPROVED') {
            ...
            try {
                ...
                console.error('Stack:', error.stack);
                console.error('❌'.repeat(40) + '\n');
                yield transactionRepo.update(transactionRecord.id, {
